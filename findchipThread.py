...
def split_input(input_list, numberOfLists):
	return [input_list[i::numberOfLists] for i in range(numberOfLists)]
	#output like this [['part1','part2'], ['part1','part2'] , ['part1','part2'], ['part1','part2'], ['part1','part2'] ]
...
args0 = split_input(input_list,numberOfList)[0]
args1 = split_input(input_list,numberOfList)[1]

start = perf_counter()

threads = []
for a,b in zip(args0,args1):

	t1 = Thread(target=get_items, args=(data_grabber(f'https://www.findchips.com/search/{a}?currency=USD'),))
	t2 = Thread(target=get_items, args=(data_grabber(f'https://www.findchips.com/search/{b}?currency=USD'),))
